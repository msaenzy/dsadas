...
export default function PlanesPage({ theme, onSelectPlan }: PlanesPageProps) {
  ...
  const plansDetail = [
    {
      ...
      description: 'Estructura de página única de alto impacto diseñada para profesionales independientes y servicios que requieren presencia digital inmediata.',
      timeframe: 'Alojamiento Cloud en Netlify incluido',
      included: [
        'Estructura One-Page (1 sola página / Secciones integradas)',
        'Alojamiento web en plataforma Cloud Netlify',
      ...
      excluded: [
        ...
        'Buzón de Correo Corporativo Receptor',
        'Estructura Multi-Página independiente',
      ],
      popular: false,
    },
    {
      ...
      description: 'Landing page de alta autoridad y conversión con tu propio dominio institucional para proyectar máxima credibilidad y captar prospectos.',
      timeframe: 'Dominio .COM y Hosting Cloud incluidos por 1 año',
      included: [
        ...
        'Diseño 100% Mobile-First & Carga <1s',
    ...
    {
      id: 'plan-3',
      badge: 'MÁXIMA AUTORIDAD & ALCANCE',
      title: 'Sitio Web Corporativo Completo',
      subtitle: 'Multi-Página + Dominio + Correo Receptor',
      description: 'Sitio web integral multi-página para empresas y marcas que requieren múltiples secciones y canal de recepción corporativo centralizado.',
      timeframe: 'Hosting Corporativo + SSL + Correo Receptor incluidos',
      included: [
        ...
        'Atención y asesoría técnica prioritaria en Ecuador',
      ],
      excluded: [],
      popular: false,
    },
  ...
  const faqs = [
    ...
    {
      q: '¿El dominio y correo corporativo vienen incluidos?',
      a: 'El Plan Corporativo Pro incluye el registro de tu dominio propio .COM y hosting de alto rendimiento por 1 año. El Plan Sitio Web Corporativo Completo incluye además un buzón de correo corporativo institucional configurado como receptor para captar solicitudes y reenviarlas directamente a tu bandeja o WhatsApp. En el Plan One-Page, la web queda alojada en Netlify sin dominio propio.',
    },
    {
